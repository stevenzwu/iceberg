...
public class TableProperties {
  ...
  public static final String MANIFEST_ADAPTIVE_TREE_ENABLED =
      "commit.manifest.adaptive-tree.enabled";
  public static final boolean MANIFEST_ADAPTIVE_TREE_ENABLED_DEFAULT = false;
