...
public class GenericManifestFile extends SupportsIndexProjection
  ...
  // v4+: counts for REPLACED entries persisted on the v4+ root manifest. Null for pre-v4 manifest
  // list entries which don't carry these fields. Populated via the 21-arg v4+ constructor variant
  // by v4+ writers/readers; no public setter.
  ...
  public static class CopyBuilder {
     ...
     * TrackedFileWriter} to resolve {@link ManifestWriter#UNASSIGNED_SEQ} on a freshly written leaf
     * manifest before it is emitted as a root-manifest entry, mirroring {@code
