...
public class ReachableFileUtil {
  ...
  /**
   * @deprecated since 4.0; use {@link #snapshotFileLocations(Table)}. The method returns v4+ root
   *     manifest locations too, so the name no longer matches its behavior.
   */
  @Deprecated
  ...
  /**
   * @deprecated since 4.0; use {@link #snapshotFileLocations(Table, Set)}. The method returns v4+
