...
class WatermarkUpdater implements EventTimeAlignmentAssignerState.StateChangeListener {
  ...
  WatermarkUpdater(
    ...
    this.inCompleteSplits = new TreeSet<>(new AscendingTimestampSplitComparator(timestampAssigner));
