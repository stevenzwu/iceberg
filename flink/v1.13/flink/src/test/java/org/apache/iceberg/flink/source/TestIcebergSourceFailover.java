...
public class TestIcebergSourceFailover {
  ...
  protected IcebergSource.Builder<RowData> sourceBuilder() {
    ...
    return IcebergSource.<RowData>builder()
        ...
        .readerFunction(new RowDataReaderFunction(
            config, sourceTableResource.table(), null, null, false));
  }
  ...
  protected void assertRecords(Table table, List<Record> expectedRecords) throws Exception {
    SimpleDataUtil.assertTableRecords(table,
        expectedRecords, Duration.ofMillis(10), 12000);
  }
