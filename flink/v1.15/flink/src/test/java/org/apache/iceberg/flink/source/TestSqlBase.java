...
public abstract class TestSqlBase {
  ...
  public void testResiduals() throws Exception {
    ...
    org.apache.iceberg.flink.TestHelpers.assertRecords(run(
        Maps.newHashMap(), "where dt='2020-03-20' and id=123", "*"), expectedRecords, TestFixtures.SCHEMA);
  }
  ...
  public void testExposeLocality() throws Exception {
    ...
    Assert.assertFalse("Expose split locality info should be false.",
