...
public abstract class TestFlinkScan {
  ...
  @Rule
  public final HadoopCatalogResource catalogResource = new HadoopCatalogResource(
  ...
  public void testUnpartitionedTable() throws Exception {
    Table table = catalogResource.catalog().createTable(TestFixtures.TABLE_IDENTIFIER, TestFixtures.SCHEMA);
  ...
  public void testPartitionedTable() throws Exception {
    Table table = catalogResource.catalog().createTable(
        TestFixtures.TABLE_IDENTIFIER, TestFixtures.SCHEMA, TestFixtures.SPEC);
  ...
  public void testIdentityPartitionProjections() throws Exception {
    ...
    Table table = catalogResource.catalog().createTable(TestFixtures.TABLE_IDENTIFIER, logSchema, spec);
  ...
  public void testPartitionTypes() throws Exception {
    ...
    Table table = catalogResource.catalog().createTable(TestFixtures.TABLE_IDENTIFIER, typesSchema, spec);
