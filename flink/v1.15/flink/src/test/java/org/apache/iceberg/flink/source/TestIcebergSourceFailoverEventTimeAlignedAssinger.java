...
/**
 * This is ignored because testContinuousWithJobManagerFailover is flaky. Maybe there is a bug in
 * the EventTimeAlignmentAssigner, as we didn't see the same flaky problem for the base class
...
public class TestIcebergSourceFailoverEventTimeAlignedAssinger extends TestIcebergSourceFailover {
  ...
  protected IcebergSource.Builder<RowData> sourceBuilder() {
    ...
    return IcebergSource.<RowData>builder()
        ...
        .assignerFactory(
            new EventTimeAlignmentAssignerFactory(
                TestFixtures.TABLE,
  ...
  private static class IcebergSourceSplitTimeAssigner
      implements Serializable, TimestampAssigner<IcebergSourceSplit> {
