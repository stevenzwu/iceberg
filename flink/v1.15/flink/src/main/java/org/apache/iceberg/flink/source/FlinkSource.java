...
public class FlinkSource {
  ...
  public static class Builder {
    ...
    public FlinkInputFormat buildFormat() {
      ...
      contextBuilder.exposeLocality(SourceUtil.isLocalityEnabled(table, readableConfig, exposeLocality));
    ...
    public DataStream<RowData> build() {
      ...
      if (!context.isStreaming()) {
        int parallelism = SourceUtil.inferParallelism(readableConfig, context.limit(), () -> {
          try {
