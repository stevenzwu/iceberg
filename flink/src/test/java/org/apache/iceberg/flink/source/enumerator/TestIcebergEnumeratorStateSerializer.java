...
public class TestIcebergEnumeratorStateSerializer {
  ...
  public void testSomeSnapshotIdAndPendingSplits() throws Exception {
    ...
    final Map<IcebergSourceSplit, IcebergSourceSplit.Status> pendingSplits = new HashMap<>();
    pendingSplits.put(splits.get(0), IcebergSourceSplit.Status.UNASSIGNED);
    pendingSplits.put(splits.get(1), IcebergSourceSplit.Status.ASSIGNED);
    pendingSplits.put(splits.get(2), IcebergSourceSplit.Status.COMPLETED);
