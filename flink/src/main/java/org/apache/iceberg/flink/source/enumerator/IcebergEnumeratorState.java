...
public class IcebergEnumeratorState implements Serializable {
  ...
  public IcebergEnumeratorState(Map<IcebergSourceSplit, IcebergSourceSplit.Status> pendingSplits) {
    this(null, pendingSplits);
  }

  public IcebergEnumeratorState(
      @Nullable IcebergEnumeratorPosition enumeratorPosition,
      Map<IcebergSourceSplit, IcebergSourceSplit.Status> pendingSplits) {
  ...
  public Map<IcebergSourceSplit, IcebergSourceSplit.Status> pendingSplits() {
