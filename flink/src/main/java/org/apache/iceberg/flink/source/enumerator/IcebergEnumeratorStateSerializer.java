...
public class IcebergEnumeratorStateSerializer implements SimpleVersionedSerializer<IcebergEnumeratorState> {
  ...
  private byte[] serializeV1(IcebergEnumeratorState enumState) throws IOException {
    ...
    for (Map.Entry<IcebergSourceSplit, IcebergSourceSplit.Status> e : enumState.pendingSplits().entrySet()) {
  ...
  private IcebergEnumeratorState deserializeV1(byte[] serialized) throws IOException {
    ...
    final Map<IcebergSourceSplit, IcebergSourceSplit.Status> pendingSplits = new HashMap<>(splitCount);
    for (int i = 0; i < splitCount; ++i) {
      ...
      IcebergSourceSplit.Status splitStatus = IcebergSourceSplit.Status.valueOf(statusName);
